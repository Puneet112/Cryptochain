...
describe('Transaction', () => {
    ...
    describe('outputMap', () => {
        ...
        it('outputs the balance to the `senderWallet`', () => {
    ...
    describe('input', () => {
        ...
        it('sets the amount to the balance of the `senderWallet', () => {
            expect(transaction.input.amount).toEqual(senderWallet.balance);
        });
        it('sets the address to the publicKey of the `senderWallet', () => {
            expect(transaction.input.address).toEqual(senderWallet.publicKey);
        });
        it('signs the input and verifies the signature', () => {
            expect(
                verifySignature({
    ...
    describe('validTransaction()', () => {
        ...
        describe('when the transaction is invalid', () => {
            ...
            describe("and the transaction `signature` value is invalid", () => {
                it("returns false", () => {
                    transaction.input.signature = new Wallet().sign('new data');
                    expect(Transaction.validTransaction(transaction)).toBe(false);
                    expect(errorMock).toHaveBeenCalled();
                });
            });
